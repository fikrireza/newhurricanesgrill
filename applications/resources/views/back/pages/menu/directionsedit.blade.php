      ...
      <div class="col-md-8">
        <div class="box box-danger">
                ...
                <tr>
                  <td>
                    <div class="form-group {{ $errors->has('directions') ? 'has-error' : '' }}">
                      <textarea class="textarea form-control" name="directions" placeholder="Directions" style="width: 100%; height: 250px; font-size: 12px; border: 1px solid #dddddd; padding: 10px;">{{ $menus->directions }}</textarea>
          ...
          <div class="box-footer clearfix">
            <button type="submit" class="btn bg-orange pull-right btn-sm btn-flat">Update Directions</button>
          </div>
        </div>
      </div>
    </form>
